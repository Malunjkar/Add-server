...
<body>
    ...
    if($_SESSION['uname']=='Akshay'){
    include_once "../config.php";
    $get="SELECT * FROM advertiser_register ORDER BY advertiser_name";
    $query=mysqli_query($conn,$get);
    echo "<div class='bs-example4' data-example-id='contextual-table' style='overflow-x:auto;'>
    <table class='table table-striped table-hover  info table-bordered table-responsive'>
        <tr>
    ...
    $id=$res['advertiser_id'];
      ...
      <td>" ?> 
            <form action="deleteadvertiser.php" method="POST">
